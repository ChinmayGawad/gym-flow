...
import { Play, Pause, Plus, Minus, Sliders, X, Radio } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-4 sm:right-6 z-40">
      {!isOpen ? (
        ...
        <div className="w-[320px] sm:w-[340px] p-4 rounded-2xl bg-white/95 dark:bg-[#131418]/95 backdrop-blur-xl border border-black/[0.1] dark:border-white/[0.1] shadow-2xl animate-in fade-in slide-in-from-bottom-3 duration-200">
          {/* Header */}
          ...
          <div className="flex items-center justify-between bg-zinc-50 dark:bg-zinc-900/80 p-2.5 rounded-xl border border-zinc-200/50 dark:border-zinc-800 mb-3">
            ...
            <Button
              ...
              size="sm"
              variant="outline"
              className="h-7 px-2.5 text-xs font-bold gap-1 rounded-lg border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700 cursor-pointer"
            >
              {isAutoSimulating ? (
                <>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-zinc-100 dark:border-zinc-800">
            ...
            <div className="flex items-center gap-1.5">
              <Button
                ...
                variant="outline"
                size="sm"
                className="h-7 px-2.5 text-xs font-bold rounded-lg border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700 gap-1 cursor-pointer"
                title="Member Exit (-1)"
              >
